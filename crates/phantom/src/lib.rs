...
pub mod profile {
    ...
    pub use phantom_profile::{
        ...
        Http2HpackSettings, Http2HuffmanCoding, Http2Priority, Http2PseudoHeader,
        Http2RejectedConnect, Http2Setting, Http2Settings, Http2StaticNameIndex,
        Http3ClientSettings, Http3PseudoHeader, Http3QpackDecoderStream, Http3QpackEncoding,
