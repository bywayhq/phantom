...
| [`request-template`](request_template.rs) | Send a navigation, then a `fetch`, with Chrome 154's request templates | `cargo run -p phantom-http --example request-template -- [url] [fetch-path]` | None | [Browser profiles](../../../docs/guides/profiles.md#apply-a-captured-request-template) |
...
| [`cookies`](cookies.rs) | Send two requests that share a cookie jar | `cargo run -p phantom-http --example cookies --features cookies -- [url]` | `cookies` | [Connections, redirects, and cookies](../../../docs/guides/connections-and-state.md#keep-cookies-between-requests) |
...
- [Using the client](../../../docs/guides/client.md): timeouts, bodies,
  errors, and negotiated requests.
