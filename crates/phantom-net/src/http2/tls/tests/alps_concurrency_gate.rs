...
const ALPS_FINAL_ZERO_CONCURRENCY: &[u8] = &[
    0x00, 0x00, 0x06, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, // SETTINGS frame
    0x00, 0x03, 0x00, 0x00, 0x00, 0x01, // MAX_CONCURRENT_STREAMS = 1
    0x00, 0x00, 0x06, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, // SETTINGS frame
...
-> TestResult<()> {
    bounded_tls_test(async {
        ...
        let server = tokio::spawn(async move {
            let mut stream = accept_alps(listener, acceptor, ALPS_FINAL_ZERO_CONCURRENCY).await?;
