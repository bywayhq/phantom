...
use super::{
    ...
    v153_tls, v153_windows_client_hints, v154_http2, v154_http3_tls, v154_tls,
    v154_windows_client_hints,
};
...
/// Chrome 154 keeps the eleven hint names, their order, and their delivery;
/// only the persona values changed.
#[test]
fn chrome_154_client_hints_keep_the_153_names_order_and_delivery() {
    let names = |settings: crate::ClientHintSettings| {
        settings
            .hints()
            .iter()
