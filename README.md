...
| --- | --- |
| Protocols | Ordered streaming H1, multiplexed H2, direct H3 over QUIC, one-handshake direct H1/H2 negotiation, and ordered static or streaming-body-produced request trailers |
