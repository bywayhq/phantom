...
| Public client | Immutable direct-HTTPS facade; exact H1/H2 selection; additive DER trust roots; ordered request fields; unified streaming response body; typed stable error categories | H3 facade after typed QUIC construction, then route policy, pooling, and session state |
