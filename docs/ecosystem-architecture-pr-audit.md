...
|---|---|---|
| **Current** | `phantom::profile::{ClientProfile, TlsSettings, Http2Settings, ...}` | Owned TLS and optional H2 components; identity metadata remains descriptive and does not switch transport code. |
